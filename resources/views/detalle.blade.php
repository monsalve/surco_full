            ...
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto align-self-center">
                    @if ($curso->tipo == 1)
                        ...
                        <p><strong class="text-black d-block">Instructor:</strong> {{$tutores[$curso->tutor]}}</p>
                        <p><strong class="text-black d-block">Duracion:</strong> {{$curso->duracion}}
                            
                            @if($curso->tipo_duracion == 1) Horas
                            @elseif($curso->tipo_duracion == 2) Días
                            @else Meses
                            @endif</p>
                        <p><strong class="text-black d-block">Categoria:</strong> {{$categorias[$curso->categoria]}}</p>
